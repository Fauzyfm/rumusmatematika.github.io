            ...
            <div className="container mt-3">
                ...
                <div className="row justify-content-center m-4">
                    <div className="col-md-5 text-center">
                        <button className='bg-2 w-100 border-0 p-2' onClick={CheckModal1} >Menghitung Luas Permukaan Balok</button>
                    </div>
                </div>
                ...
                <div class="row justify-content-center m-4">
                    <div className="col-md-5 text-center">
                        <button className='bg-2 w-100 border-0 p-2' onClick={CheckModal2} >Menghitung Volume Balok </button>
                    </div>
                </div>
                ...
                <div class="row justify-content-center m-4">
                    <div className="col-md-5 text-center">
                        <button className='bg-2 w-100 border-0 p-2' onClick={CheckModal3} >Menghitung Keliling Balok</button>
                    </div>
                </div>

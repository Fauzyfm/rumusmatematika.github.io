            ...
            <div className="container mt-3">
                ...
                <div className="row justify-content-center m-4">
                    <div className="col-md-5 text-center">
                        <button className='btn-primary w-100 p-2' onClick={CheckModal1} >Menghitung Luas Segi Empat</button>
                    </div>
                </div>
                ...
                <div class="row justify-content-center m-4">
                    <div className="col-md-5 text-center">
                        <button className='btn-primary w-100 p-2' onClick={CheckModal2} >Menghitung Keliling Segi Empat</button>
                    </div>
                </div>
